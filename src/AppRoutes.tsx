...
const pillarDataMap = {
  auto: autoAccidentLaw,
  pi: personalInjuryLaw,
  insurance: insuranceLaw,
  employment: employmentLaw,
  criminal: criminalLaw,
  landlord: landlordTenantLaw,
  aitech: aiTechLaw,
} as const;
...
const AutoInsuranceClaimGuide = React.lazy(() => import("@/pages/AutoInsuranceClaimGuide"));
const DebtSettlementCalculatorPage = React.lazy(() => import("@/pages/DebtSettlementCalculatorPage"));
 ...
 * no prefix) and once nested under "/:lang/*" for other supported locales.
 * Because nested <Routes> resolve relative to the parent match, the same tree
 * works under both mounts unmodified.
 */
