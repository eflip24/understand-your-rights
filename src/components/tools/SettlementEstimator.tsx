...
import { AlertTriangle, DollarSign, TrendingDown, ExternalLink } from "lucide-react";
...
// Pain-and-suffering per-diem rate — commonly 1–3× daily wage
const perDiemFactor = { low: 1, high: 3 };

// Contingency fee bands
...
export default function SettlementEstimator() {
  ...
  const result = useMemo(() => {
    ...
    if (method === "multiplier") {
      ...
      // Pain & suffering = multiplier × medical-related economic (excluding property)
    ...
    let grossLow = economic + painLow;
    let grossHigh = economic + painHigh;
    ...
    // Attorney fees / costs / liens → net to client
    ...
    return {
      ...
      cappedHigh,
      cappedByLimit,
      feeLow: cappedLow * feeRate,
      feeHigh: cappedHigh * feeRate,
      netLow,
      netHigh,
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-serif font-bold text-lg">Economic damages (out-of-pocket)</h3>
          </div>
      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          <h3 className="font-serif font-bold text-lg">Pain &amp; suffering (non-economic)</h3>
      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          <h3 className="font-serif font-bold text-lg">Real-world adjustments</h3>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          <h3 className="font-serif font-bold text-lg">Net to you (after fees, costs, liens)</h3>
        ...
        <Card className="border-primary/30 bg-primary/5">
          <CardContent className="pt-6 space-y-4">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              ...
              <Button asChild size="sm" variant="outline">
                <Link to="/local-lawyers">Find a personal injury lawyer <ExternalLink className="w-3 h-3 ml-1" /></Link>
              </Button>
            </div>
          </CardContent>
        </Card>
