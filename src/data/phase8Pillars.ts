...
export const phase8Pillars: Phase8Pillar[] = [
  ...
  /* ------------------------------------------------------------------ 2 */
  {
    ...
    faqs: [
      ...
      { question: "How long do I have to file?", answer: "The personal-injury statute of limitations in your state governs — commonly two or three years, but as short as one year in Kentucky and Tennessee (Louisiana moved to two years for torts arising on or after 1 July 2024). Platform reporting deadlines are much shorter in practice, so report immediately." },
        ...
        tables: [
          {
            ...
            rows: [
              ["Roundup (product liability)", "Diagnosis, or discovery of the link", "State statute of limitations — commonly 2–3 years, 1 year in Tennessee and Kentucky", "None; file suit or join an inventory"],
