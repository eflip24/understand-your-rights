...
const toolComponents: Record<string, React.LazyExoticComponent<React.ComponentType>> = {
  ...
  "force-majeure-checker": React.lazy(() => import("@/components/tools/ForceMajeureChecker")),
  "auto-renewal-detector": React.lazy(() => import("@/components/tools/AutoRenewalDetector")),
  "governing-law-id": React.lazy(() => import("@/components/tools/GoverningLawIdentifier")),
  "plain-english-rewriter": React.lazy(() => import("@/components/tools/PlainEnglishRewriter")),
  "chargeback-checker": React.lazy(() => import("@/components/tools/ChargebackChecker")),
  "lemon-law-qualifier": React.lazy(() => import("@/components/tools/LemonLawQualifier")),
  "subscription-cancel-letter": React.lazy(() => import("@/components/tools/SubscriptionCancellationLetter")),
  "data-breach-checklist": React.lazy(() => import("@/components/tools/DataBreachChecklist")),
  "final-paycheck-lookup": React.lazy(() => import("@/components/tools/FinalPaycheckLookup")),
  "unemployment-estimator": React.lazy(() => import("@/components/tools/UnemploymentEstimator")),
  "nda-vs-noncompete": React.lazy(() => import("@/components/tools/NDAvsNonCompete")),
  "discrimination-checklist": React.lazy(() => import("@/components/tools/DiscriminationChecklist")),
  "eviction-notice-lookup": React.lazy(() => import("@/components/tools/EvictionNoticeLookup")),
  "habitability-tracker": React.lazy(() => import("@/components/tools/HabitabilityTracker")),
  "mortgage-affordability": React.lazy(() => import("@/components/tools/MortgageAffordability")),
  "operating-agreement-llc": React.lazy(() => import("@/components/tools/OperatingAgreementGenerator")),
  "founders-agreement": React.lazy(() => import("@/components/tools/FoundersAgreementGenerator")),
  "dmca-generator": React.lazy(() => import("@/components/tools/DMCAGenerator")),
  "emergency-fund": React.lazy(() => import("@/components/tools/EmergencyFundCalculator")),
  "tip-splitter": React.lazy(() => import("@/components/tools/TipSplitter")),
  "net-metering": React.lazy(() => import("@/components/tools/NetMeteringEstimator")),
  "child-support": React.lazy(() => import("@/components/tools/ChildSupportCalculator")),
  "alimony-calc": React.lazy(() => import("@/components/tools/AlimonyCalculator")),
  "divorce-cost": React.lazy(() => import("@/components/tools/DivorceCostEstimator")),
  "sol-deadline": React.lazy(() => import("@/components/tools/StatuteOfLimitationsDeadlineCalculator")),
